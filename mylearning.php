    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="dropdown"><a href="#"><span>Our courses</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="https://2300-102-220-12-50.ngrok-free.app/maw/course-login.php">All Courses</a></li>
              ...
              <li class="dropdown"><a href="shortCourses.php"><span>Short Courses</span> </a>
              </li>
              
            </ul>
            <li><a href="#mylearning">My learning</a></li>
            <li><a href="https://2300-102-220-12-50.ngrok-free.app/maw/contact-login.php">Contact</a></li>
          </li>
          <li class="dropdown"><a href="#"><span>More</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="https://2300-102-220-12-50.ngrok-free.app/maw/about-login.php">About Us</a></li>
              <li><a href="https://2300-102-220-12-50.ngrok-free.app/maw/career-login.php">Career</a></li>
             <li><a href="https://2300-102-220-12-50.ngrok-free.app/maw/blog-login.php">Blog</a></li>
              <li><a href="https://2300-102-220-12-50.ngrok-free.app/maw/faq-login.php">FAQs</a></li>
            </ul>
          </li>
        ...
        <div class="submenuwrap" id="subMenu">
          <div class="submenu">
            ...
            <hr>
            <a href="editInfom.php" class="submenulinks">
              <p>Edit profile</p>
              <span>></span>
            </a>
            <hr>
            <a href="logout.php" class="submenulinks">
              <p>logout</p>
              <span>></span>
            </a>
          </div>
    ...
    <div class="container">
      <table >
        ...
        /*else{
          ...
          echo "You have not yet applied to any course.
          please click all courses tab to apply.";
