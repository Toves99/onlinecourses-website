...
$sql="SELECT * FROM course WHERE course_id IN(8,9,10,11,12,13,14,15,16)";
        ...
        <ul>
          <li class="dropdown"><a href="#container"><span>All courses</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li><a href="webApplicatioCourses.php">Web Application develoment courses</a></li>
              <li><a href="databaseCourses.php">Database programming courses</a></li>
              <li><a href="#"><span>Short Courses</span> </a>
              </li>
            </ul>
          </li>
