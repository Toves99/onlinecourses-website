...
if(isset($_POST['submit'])){
   ...
   //echo "uname from the logged in user is:".$uname;
    ...
    $data=[$file1,$file2];
    $images=implode('',$data);
    $insert_query="UPDATE `user_information` SET `fullname`='$fullname',`phone`='$phone',`day`='$day',`month`='$month',`year`='$year,`gender`='$gender',`country`='$country',`image`='$images',`level`='$level',`school`='$school',`grade`='$grade',`laptop`='$laptop',`programming`='$programming'";
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-one form-step active">
                        ...
                        <div>
                            ...
                            <input type="file" <?php echo $row['image'] ?> name="image">
                        </div>
                        <div>
                            <label>Country</label>
                    ...
                    <div class="form-two form-step">
                        ...
                        <div>
                            ...
                            <input type="text" name="school" <?php echo $row['school'] ?> placeholder="eg Chuka university" required>
                        </div>
                        <div>
                            <label>Grade attained</label>
                            <input type="text" name="grade" <?php echo $row['grade'] ?> placeholder="Type your grade" required>
                        </div>
                        <div>
                            <label>Upload your Academic Documents</label>
                            <input type="file" name="image1" <?php echo $row['image1'] ?> multiple>
                        </div>
                        <div>
